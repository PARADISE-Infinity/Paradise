...
import de.dlr.premise.element.provider.ModeItemProvider;
 ...
 *
 */
public class ModeItemProviderMy extends ModeItemProvider {

    public ModeItemProviderMy(AdapterFactory adapterFactory) {
    ...
    public String getText(Object object) {
        ...
        if (PremiseHelper.isSet((EObject) object, SystemItemProviderAdapterFactoryMy.OPT_DATA_TYPE_NAMES)) {
            ...
            if (!el.getMetaTypes().isEmpty()) {
                ...
                typeName = getString("_UI_Mode_type");
            }
    ...
    public Object getImage(Object object) {
        return imageHelper.getImage((IMetaTypable) object, getResourceLocator().getImage("full/obj16/Mode"));
    }
}
