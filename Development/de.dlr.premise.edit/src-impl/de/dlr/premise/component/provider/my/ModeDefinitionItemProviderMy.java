...
import de.dlr.premise.component.provider.ModeDefinitionItemProvider;
...
public class ModeDefinitionItemProviderMy extends ModeDefinitionItemProvider {

    public ModeDefinitionItemProviderMy(AdapterFactory adapterFactory) {
    ...
    public String getText(Object object) {
        ...
        if (PremiseHelper.isSet(eObject, SystemItemProviderAdapterFactoryMy.OPT_DATA_TYPE_NAMES)) {
            typeName = getString("_UI_ModeDefinition_type");
    ...
    public Object getImage(Object object) {
        return imageHelper.getImage((IMetaTypable) object, getResourceLocator().getImage("full/obj16/ModeDefinition"));
    }
}
