...
public class GeneratorTest {
    ...
    private static String PATH_OUTPUT_FILE =
            de.dlr.premise.util.TestHelper.locateFile("de.dlr.exchange.petrinet.snoopy.xtend", "test/data/WindTurbine.snoopy.spped")
                                          .getPath();
    ...
    public void test() {
        ...
        assertEquals(79729, TestHelper.saveFile(fsa, PATH_OUTPUT_FILE).length());
    }
}
