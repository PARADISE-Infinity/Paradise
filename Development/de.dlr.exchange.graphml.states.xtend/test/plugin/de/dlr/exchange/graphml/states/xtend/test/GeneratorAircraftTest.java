...
public class GeneratorAircraftTest extends de.dlr.premise.util.TestHelper {
    ...
    public void test() {
        ...
        assertEquals(64290, files.get(0).length());
        assertEquals(137573, files.get(1).length());
    }
}
