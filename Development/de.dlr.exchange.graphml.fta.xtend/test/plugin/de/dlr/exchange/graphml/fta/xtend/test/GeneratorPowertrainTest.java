...
public class GeneratorPowertrainTest {

    private static String PATH_INPUT_FILE =
            de.dlr.premise.util.TestHelper.locateFile("de.dlr.exchange.graphml.fta.xtend", "test/data/PowerTrain_activation.premise")
                                          .getPath();
    private static String PATH_OUTPUT_FILE =
            de.dlr.premise.util.TestHelper.locateFile("de.dlr.exchange.graphml.fta.xtend", "test/data/PowerTrain_activation.fta.graphml")
                                          .getPath();
    ...
    public void test() {
        ...
        assertEquals(33177, TestHelper.saveFile(fsa, PATH_OUTPUT_FILE).length());
