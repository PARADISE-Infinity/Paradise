...
public class GeneratorVFW614Test {

    private static String PATH_INPUT_FILE =
            de.dlr.premise.util.TestHelper.locateFile("de.dlr.exchange.graphml.fta.xtend", "test/data/VFW614_PSSA_excerpt.premise")
                                          .getPath();
    private static String PATH_OUTPUT_FILE =
            de.dlr.premise.util.TestHelper.locateFile("de.dlr.exchange.graphml.fta.xtend", "test/data/VFW_614_excerpt.fta.graphml")
                                          .getPath();
    ...
    public void test() {
        ...
        assertEquals(28396, TestHelper.saveFile(fsa, PATH_OUTPUT_FILE).length());
