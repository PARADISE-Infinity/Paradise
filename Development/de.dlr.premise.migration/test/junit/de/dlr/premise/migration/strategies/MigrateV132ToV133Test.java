...
public class MigrateV132ToV133Test {

    private static String NAME = "MigrateV132ToV133";
   ...
   @Test
    public void testMigration() throws IOException, SAXException, ParserConfigurationException, MigrationMissingException {
       ...
       MigrationStrategy.migrate(model, "1.33");
       model.save();

       // test migration
       assertTrue(model.wasChanged());
       assertEquals("1.33", model.getModelRoot().getAttribute("metaModel"));
