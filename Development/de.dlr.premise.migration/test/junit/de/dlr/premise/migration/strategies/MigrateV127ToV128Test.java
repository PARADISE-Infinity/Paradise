...
public class MigrateV127ToV128Test {

    private static String NAME = "MigrateV127ToV128";
   ...
   @Test
    public void testMigration() throws IOException, SAXException, ParserConfigurationException, MigrationMissingException {
       ...
       MigrationStrategy.migrate(model, "1.28");
       model.save();

       // test migration
       assertTrue(model.wasChanged());
       assertEquals("1.28", model.getModelRoot().getAttribute("metaModel"));
