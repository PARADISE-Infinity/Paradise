...
public class MigrateV130ToV131Test {

    private static String NAME = "MigrateV130ToV131";
   ...
   @Test
    public void testMigration() throws IOException, SAXException, ParserConfigurationException, MigrationMissingException {
       ...
       MigrationStrategy.migrate(model, "1.31");
       model.save();

       // test migration
       assertTrue(model.wasChanged());
       assertEquals("1.31", model.getModelRoot().getAttribute("metaModel"));
