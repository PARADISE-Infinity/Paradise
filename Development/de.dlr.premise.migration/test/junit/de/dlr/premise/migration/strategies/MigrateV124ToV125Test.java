...
public class MigrateV124ToV125Test {

    private static String NAME = "MigrateV124ToV125";
   ...
   @Test
    public void testMigration() throws IOException, SAXException, ParserConfigurationException, MigrationMissingException {
        ...
        MigrationStrategy.migrate(model, "1.25");
        model.save();

        // test migration
        assertTrue(model.wasChanged());
        assertEquals("1.25", model.getModelRoot().getAttribute("metaModel"));
