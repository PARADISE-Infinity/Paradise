...
public class MigrateV129ToV130Test {

    private static String NAME = "MigrateV129ToV130";
   ...
   @Test
    public void testMigration() throws IOException, SAXException, ParserConfigurationException, MigrationMissingException {
       ...
       MigrationStrategy.migrate(model, "1.30");
       model.save();

       // test migration
       assertTrue(model.wasChanged());
       assertEquals("1.30", model.getModelRoot().getAttribute("metaModel"));
