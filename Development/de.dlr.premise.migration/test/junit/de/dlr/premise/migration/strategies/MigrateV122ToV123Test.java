...
public class MigrateV122ToV123Test {

    private static String NAME = "MigrateV122ToV123";

    private static String FILENAME_PREMISE = "MigrateV122ToV123.premise";
    ...
    private static String FILENAME_USECASE = "MigrateV122ToV123.usecase";
    ...
    private static String FILENAME_COMPONENT = "MigrateV122ToV123.component";
   ...
   @Test
    public void testMigration() throws IOException, SAXException, ParserConfigurationException, MigrationMissingException {
        ...
        MigrationStrategy.migrate(model, "1.23");
        model.save();

        // test migration
        assertTrue(model.wasChanged());
        assertEquals("1.23", model.getModelRoot().getAttribute("metaModel"));
