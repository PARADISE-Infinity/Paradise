...
public class MigrateV131ToV132Test {

    private static String NAME = "MigrateV131ToV132";
   ...
   @Test
    public void testMigration() throws IOException, SAXException, ParserConfigurationException, MigrationMissingException {
       ...
       MigrationStrategy.migrate(model, "1.32");
       model.save();

       // test migration
       assertTrue(model.wasChanged());
       assertEquals("1.32", model.getModelRoot().getAttribute("metaModel"));
