...
public class MigrateV121ToV122Test {

    private static String NAME = "MigrateV121ToV122";

    private static String FILENAME_PREMISE = "MigrateV121ToV122.premise";
    ...
    private static String FILENAME_USECASE = "MigrateV121ToV122.usecase";
    ...
    private static String FILENAME_COMPONENT = "MigrateV121ToV122.component";
    ...
    public void testMigration() throws IOException, SAXException, ParserConfigurationException, MigrationMissingException {
        ...
        MigrationStrategy.migrate(model, "1.22");
        model.save();

        // test migration
        assertTrue(model.wasChanged());
        assertEquals("1.22", model.getModelRoot().getAttribute("metaModel"));
