...
public class MigrateV117ToV118Test {

    private static String NAME = "MigrateV117ToV118";

    private static String FILENAME_PREMISE = "WindTurbine.premise";
    ...
    public void testMigration() throws IOException, SAXException, ParserConfigurationException, MigrationMissingException {
        ...
        MigrationStrategy.migrate(model, "1.18");
        model.save();

        // test migration
        assertTrue(model.wasChanged());
        assertEquals("1.18", model.getModelRoot().getAttribute("metaModel"));
